#!/usr/bin/env python3
"""
Neural Network baseline classifier for ALL data.
Uses quantitative features from the primary ticker's get_ticker_node_features method.
"""
...
def extract_simple_features(data):
    """Extract simple features from the data without using SubGraph."""
    features = []
    labels = []
    eps_surprises = []
    valid_samples = 0
    
    print("Extracting simple features from data...")
    ...
    print(f"Successfully extracted features for {valid_samples}/{len(data)} samples")
...
def evaluate_predictions(y_true, y_pred, y_prob):
    ...
    # Print results
    print("=" * 50)
    print("NEURAL NETWORK BASELINE RESULTS - ALL DATA")
    print("=" * 50)
...
def plot_confusion_matrix(cm, save_path=None):
    ...
    plt.title('Confusion Matrix - Neural Network Baseline (All Data)')
...
def plot_training_history(train_losses, val_losses, save_path=None):
    ...
    plt.xlabel('Epoch')
    plt.ylabel('Loss')
    plt.title('Training History - Neural Network Baseline')
    plt.legend()
...
def main():
    """Main function to run the neural network baseline on all data."""
    # Load data
    ...
    plot_confusion_matrix(cm, 'Baselines/neural_net/all_data/nn_baseline_all_confusion_matrix.png')
    
    # Plot training history
    plot_training_history(train_losses, val_losses, 'Baselines/neural_net/all_data/nn_baseline_all_training_history.png')
    ...
    with open('Baselines/neural_net/all_data/nn_baseline_all_results.json', 'w') as f:
        json.dump(results, f, indent=2)
    
    print("Results saved to Baselines/neural_net/all_data/nn_baseline_all_results.json")
