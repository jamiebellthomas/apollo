#!/usr/bin/env python3
"""
Comprehensive test suite for HeteroGNN to verify it works correctly with the existing data format.
...
def test_edge_mixer():
    """Test the edge mixer component."""
    print("=== TESTING EDGE MIXER ===")
    
    # Create a simple HeteroGNN to access the edge mixer
    ...
    # Test edge mixer with sample data
    ...
    # Test edge gate computation
    edge_gates = model.edge_gate(model.edge_mixer(edge_attr))
    print(f"Edge gates shape: {edge_gates.shape}")
    print(f"Edge gates values: {edge_gates.squeeze()}")
    print(f"Gate range: [{edge_gates.min():.3f}, {edge_gates.max():.3f}]")
    
    # Check that gates are in [0, 1] range
    assert torch.all(edge_gates >= 0) and torch.all(edge_gates <= 1), "Edge gates should be in [0, 1] range"
    
    print("✅ Edge mixer test passed!")
    return True

def test_heterognn_basic():
    """Test basic HeteroGNN functionality."""
    print("\n=== TESTING HETEROGNN BASIC FUNCTIONALITY ===")
    ...
    print(f"Created HeteroGNN model with:")
    ...
    print("✅ HeteroGNN basic test passed!")
    return True

def test_heterognn_readout_modes():
    """Test different readout modes."""
    print("\n=== TESTING HETEROGNN READOUT MODES ===")
    ...
    print("✅ HeteroGNN readout modes test passed!")
    return True

def test_heterognn_batch_processing():
    """Test HeteroGNN with batched data."""
    print("\n=== TESTING HETEROGNN BATCH PROCESSING ===")
    ...
    print("✅ HeteroGNN batch processing test passed!")
    return True

def test_heterognn_edge_handling():
    """Test edge attribute handling."""
    print("\n=== TESTING HETEROGNN EDGE HANDLING ===")
    ...
    print("✅ HeteroGNN edge handling test passed!")
    return True

def test_heterognn_with_real_data():
    """Test HeteroGNN with real data from the pipeline."""
    print("\n=== TESTING HETEROGNN WITH REAL DATA ===")
    ...
    try:
        ...
        print("✅ HeteroGNN real data test passed!")
        return True
...
def test_heterognn_training_integration():
    """Test HeteroGNN integration with training pipeline."""
    print("\n=== TESTING HETEROGNN TRAINING INTEGRATION ===")
    ...
    try:
        ...
        print("✅ HeteroGNN training integration test passed!")
        return True
...
def test_heterognn_edge_cases():
    """Test edge cases and error handling."""
    print("\n=== TESTING HETEROGNN EDGE CASES ===")
    ...
    print("✅ HeteroGNN edge cases test passed!")
    return True

def test_heterognn_performance():
    """Test performance characteristics."""
    print("\n=== TESTING HETEROGNN PERFORMANCE ===")
    ...
    print("✅ HeteroGNN performance test passed!")
    return True

if __name__ == "__main__":
    print("HeteroGNN Comprehensive Test Suite")
    print("=" * 50)
    
    tests = [
        test_edge_mixer,
        test_heterognn_basic,
        test_heterognn_readout_modes,
        test_heterognn_batch_processing,
        test_heterognn_edge_handling,
        test_heterognn_with_real_data,
        test_heterognn_training_integration,
        test_heterognn_edge_cases,
        test_heterognn_performance,
    ]
    ...
    if passed == total:
        print("🎉 All tests passed! HeteroGNN is working correctly.")
    else:
